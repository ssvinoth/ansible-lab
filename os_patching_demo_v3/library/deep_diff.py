...
def main():
    ...
    try:
        # Do a Diff
        print("First Object")
        pprint(module.params['first_object'])
        print("Second Object")
        pprint(module.params['second_object'])
        ddiff={}
        t1 = module.params['first_object']
        t2 = module.params['second_object']
       #ddiff=DeepDiff(t1, t2, ignore_order=True, cutoff_distance_for_pairs=1, cutoff_intersection_for_pairs=1)
        pprint(ddiff)
        result['is_same'] = True
        # if not ddiff:
        #     result['is_same'] = True          
